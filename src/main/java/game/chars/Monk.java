...
public class Monk extends BaseHero {
    ...
    /**
     * Для Монаха (Monk) или Колдуна (Warlock) сделать ход - это проверка и выбор из нескольких вариантов: вылечить одного из своей фракции, воскресить одного из своих, нанести урон противнику, если большинство из союзников здоровы более чем на три четверти от максимума очков здоровья.
