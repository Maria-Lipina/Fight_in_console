...
public class Fight {
    ...
    /**
     * Создает объект Сражение. Применяется, когда при создании {@link game.chars.Party Party} пользователь устанавливает, из каких классов состоит команда, но не устанавливает количество представителей того или иного класса.
    ...
    /**
     * Создает объект Сражение. Применяется, когда при создании {@link game.chars.Party Party} пользователь полностью контролирует, из каких классов состоит команда, устанавливает количество представителей того или иного класса.
     * @param request массив строк, в котором пользователь передает запрос, из каких классов состоит первая команда.
     * @param request1 массив строк, в котором пользователь передает запрос, из каких классов состоит вторая команда.
