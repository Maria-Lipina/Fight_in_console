 ...
 * "StepNo" - номер раунда. "Fraction" - название фракции, одной из воюющих сторон. "Me" - имя текущего персонажа, совершившего ход. "MyPos" - координаты персонажа на игровом поле. "Target" - имя цели. "TargetPos" - координаты цели на игровом поле. "Damage val" - величина нанесенного урона (если положительное число) или количество восстановленных очков здоровья (если число отрицательное), "TgStatus" - статус цели после хода текущего персонажа.
...
*/
 public class Logger {
     ...
     * @param members ссылка на объект класса Party, в котором информация для всех столбцов файла-лога, кроме "Step".
     * @throws IOException при невозможности создать файл, записать в него (TODO: а дальше добавить как поступит программа)
     */
    ...
    /**
     * Обращается к каждому персонажу (представитель одного из наследников абстрактного класса BaseHero) в составе объекта класса Party и добавляет в файл лога полученную от персонажа информацию:
     * "Fraction" - название фракции, одной из воюющих сторон. "Me" - имя текущего персонажа, совершившего ход. "MyPos" - координаты персонажа на игровом поле. "Target" - имя цели. "TargetPos" - координаты цели на игровом поле. "Damage val" - величина нанесенного урона (если положительное число) или количество восстановленных очков здоровья (если число отрицательное), "TgStatus" - статус цели после хода текущего персонажа.
